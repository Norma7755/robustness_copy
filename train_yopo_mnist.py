...
# srun -p llmit6 --pty --cpus-per-task=12 --gres=gpu:1 --mem-per-cpu 16384 python train_yopo_mnist.py --AT_type YOPO --model_name SSM --attack_type PGD --use_inject --inject_method 1
# srun -p llmit6 --pty --cpus-per-task=12 --gres=gpu:1 --mem-per-cpu 16384 python train_yopo_mnist.py --AT_type YOPO --model_name DSS --attack_type PGD --use_inject --inject_method 1

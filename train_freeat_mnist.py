...
# srun -p llmit6 --pty --cpus-per-task=12 --gres=gpu:1 --mem-per-cpu 16384 python train_freeat_mnist.py --AT_type FreeAT --model_name DSS --attack_type PGD --use_inject --inject_method 1
...
global_noise_data = torch.zeros([args.batch_size, 1, 28, 28]).cuda()
